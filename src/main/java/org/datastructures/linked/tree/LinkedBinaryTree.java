 ...
 */
package org.datastructures.linked.tree;

import org.datastructures.array.tree.AbstractBinaryTree;
...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
	 ...
	 *            a leaf of the tree
	 * @param t1
	 *            an independent tree whose structure becomes the left child of p
	 * @param t2
	 *            an independent tree whose structure becomes the right child of p
	 * @throws IllegalArgumentException
	 *             if p is not a valid Position for this tree
	 * @throws IllegalArgumentException
	 *             if p is not a leaf
